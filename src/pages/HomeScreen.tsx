    ...
    return (
        <div className="bg-white">
            <header className="absolute inset-x-0 top-0 z-50">
                <nav aria-label="Global" className="flex h-36 items-center justify-between p-6 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-20 sm:py-10 lg:py-20">
                    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                            ...
                            <a href="#" className="font-semibold text-indigo-600">
                                ...
                                อ่านเพิ่ม <span aria-hidden="true">&rarr;</span>
                            </a>
                        </div>
                    </div>
                    <div className="text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <a href="#" className="text-sm/6 font-semibold text-gray-900">
                                เลือกชมเมนู <span aria-hidden="true">→</span>
                            </a>
                        </div>
                    </div>
                </div>
